...
namespace _02_CRUD_Interface
{
    class SalesDb: IDisposable
    {
        ...
        public void AddNewSaleBuy()
        {
            ...
            string cmdText = $@"INSERT INTO Sales Values ({sale.BuyerID},{sale.SellerID},{sale.Price},'{formatedDate}')";
        ...
        private void ShowFunction(string cmdText) {
            SqlCommand command = new SqlCommand(cmdText, sqlConnection);
